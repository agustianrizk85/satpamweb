...
const TOP_TAB_CANDIDATES: readonly TitleBarTab[] = [
  ...
  { label: "Master Ronde", href: "/web/patrol-round-masters", subLabel: "Nomor ronde" },
  ...
  { label: "Laporan Scan", href: "/web/patrol-scan-reports", subLabel: "Report scan" },
  { label: "Laporan Patroli", href: "/web/patrol-run-reports", subLabel: "Report ronde" },
